...
| Group | Tools |
| --- | --- |
| Diagnostics | `avanan_test_connection` (auth handshake, key scopes, MSP-access probe; run this first) |
...
> answers `403 MSP endpoint, access denied`. `avanan_test_connection` reports which kind
> of key you have.
